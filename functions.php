...
if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array(
        'key' => 'group_6209e0c21716d',
        'title' => 'bs_recipe',
        'fields' => array(
            array(
                'key' => 'field_6209e0edc666e',
                'label' => 'Title',
                'name' => 'title',
                'type' => 'text',
                'instructions' => 'Recipe title i.e - Apple Pie, Chocolate Dipped Donuts.',
                'required' => 1,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
                ...
                'default_value' => '',
                'placeholder' => 'Apple Pie, Donuts etc...',
                'prepend' => '',
                'append' => '',
                'maxlength' => '',
            ),
            array(
                ...
                'name' => 'content',
                'type' => 'textarea',
                'instructions' => 'Description of our recipe',
                'required' => 1,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
            ...
            array(
                ...
                'name' => 'featured_image',
                'type' => 'image',
                'instructions' => 'Add the featured image',
                'required' => 1,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
            ...
            array(
                ...
                'name' => 'servings',
                'type' => 'number',
                'instructions' => 'Amount of servings (i.e 4, 8, 12)',
                'required' => 1,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
            ...
            array(
                ...
                'name' => 'ingredients',
                'type' => 'repeater',
                'instructions' => 'List our ingredients, simply press [Add ingredient] then write each element of your recipe.
    Example: 1 Apple',
                'required' => 1,
                'conditional_logic' => 0,
                'wrapper' => array(
            ...
            array(
                ...
                'name' => 'instructions',
                'type' => 'textarea',
                'instructions' => 'Describe how it\'s made step by step. 
    Example:
    
    Whip the eggs for 30 seconds
    Make dough from oats then inside the bowl for 5 minutes
